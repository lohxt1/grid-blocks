...
const SimilarCylinderSpace = (props) => {
  return (
    <>
      <Canvas
        camera={{
      ...
      >
        <Suspense fallback={null}>
          <ambientLight />
          <mesh position={[0, 120, 0]} rotation={[Math.PI / 10, 0, 0]}>
          ...
          <mesh position={[0, 80, 0]} rotation={[Math.PI / 10, 0, 0]}>
            <cylinderBufferGeometry
              attach="geometry"
              args={[30, 30, 15, 15, 5, 5]}
            />
...
export default SimilarCylinderSpace;
